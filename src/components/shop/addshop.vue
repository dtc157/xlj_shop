    ...
    <div id="form">
      <div class="row" style>
        <div style="float:left; ">
          ...
          <input type="text" class="text" v-model="productName" style="width:540px;"  v-on:blur="AproductName()">
      ...
      <div class="row" style="width:320px; margin-left:1px;">
        <div style="float:left;">
          <div class="word">
            <p>商品序列：</p>
          </div>
          <input type="text" class="text" v-model="productCode" v-on:blur="AproductCode()">
      ...
      <div class="row" style="width:310px;">
        <div style="float:left;">
          ...
          <input type="text" class="text" v-model="productBrandId" v-on:blur="AproductBrandId()">
      ...
      <div class="row2">
        <div>
          ...
          <input type="text" class="text2" v-model="productSmallPrice" v-on:blur="AproductSmallPrice()">
          <div class="word2">￥</div>
      ...
      <div class="row2">
        <div>
          <div class="word" style="margin-left:0px;">
            <p>总价：</p>
          </div>
          <input type="text" class="text2" v-model="productLargerPrice" v-on:blur="AproductLargerPrice()">
          <div id="word2">￥</div>
      ...
      <div class="row2">
        ...
        <input type="text" class="text2"  v-model="productStandard"  v-on:blur="AproductStandard()">
      ...
      <div class="row2">
        <div class="word" style="width:90px;">
          <p>大规格：</p>
        </div>
        <input type="text" class="text2" v-model="productLargerStandard" v-on:blur="AproductLargerStandard()">
      ...
      <div class="row2">
        <div>
          ...
          <input type="text" class="text2" style="margin-right:70px;" v-model="productOrder" v-on:blur="AproductOrder()">
